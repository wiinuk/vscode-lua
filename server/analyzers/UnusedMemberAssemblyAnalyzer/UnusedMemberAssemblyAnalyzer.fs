...
[<AutoOpen>]
module private DiagnosticHelpers =
    let p, ws = Run.styled, Run.whitespace
    let showLocation l =
        try
            let full = Uri l.uri
...
module private Helpers =
    ...
    let memberUnusedCode = Diagnostic.code <| MemberUnused(FieldId(ValueNone, ""))
